...
define('SS_ksf_FA_Tracking', 139 << 8);
...
class hooks_ksf_FA_Tracking extends hooks {
    ...
    function install_tabs($app) {
        ...
        // return new ksf_FA_Tracking_app();
    }
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_Tracking] = _("");
        $security_areas['SA_ksf_FA_TrackingVIEW'] = array(
            SS_ksf_FA_Tracking | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_TrackingMANAGE'] = array(
            SS_ksf_FA_Tracking | 2, 
            _("Manage ")
        );
